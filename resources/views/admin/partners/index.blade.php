...
<header class="flex justify-between items-center mb-10">
    <div>
        ...
        <p class="text-slate-500 font-medium">Atur semua partner yang mendukung platform ini.</p>
    </div>
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-5">
                        <img
                            ...
                            alt="{{ $partner->name }}"
                            class="w-16 h-16 rounded-xl object-contain bg-slate-50 p-1 border border-slate-100"
                        >
                    </td>
                    <td class="px-8 py-5">
                ...
                <tr>
                    <td colspan="6" class="px-8 py-12 text-center text-slate-400 font-medium">
                        @if($search)
                            Tidak ada partner dengan kata kunci "{{ $search }}".
                        @else
                            Belum ada partner.
                            <a href="{{ route('admin.partners.create') }}" class="text-indigo-600 font-bold">Tambah sekarang</a>.
                        @endif
                    </td>
                </tr>
                @endforelse
