...
<main class="flex-1 p-10 overflow-y-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                ...
                <h3 class="text-2xl font-black whitespace-nowrap">Rp 12.450.000</h3>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                ...
                <h3 class="text-2xl font-black whitespace-nowrap">1.284</h3>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                ...
                <h3 class="text-2xl font-black whitespace-nowrap">8 Event</h3>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                ...
                <h3 class="text-2xl font-black whitespace-nowrap">12 Pesanan</h3>
            </div>
        </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y border-t">
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-8 py-6 font-black text-indigo-600 whitespace-nowrap">Rp 155.000</td>
                        </tr>
                        <tr class="hover:bg-slate-50 transition">
                            <td class="px-8 py-6">
                            ...
                            <td class="px-8 py-6 font-black text-indigo-600 whitespace-nowrap">Rp 55.000</td>
                        </tr>
                        <tr class="hover:bg-slate-50 transition">
                            <td class="px-8 py-6">
                            ...
                            <td class="px-8 py-6 font-black text-indigo-600 whitespace-nowrap">Rp 0</td>
                        </tr>
                    </tbody>
                </table>
            </div>
